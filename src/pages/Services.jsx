        ...
        <>
                ...
                <div className="row justify-content-center align-items-center g-3">
                    ...
                    <div className="col-md-6">
                        ...
                        <div className="text-center">
                            <a href="https://wa.me/+237671752479" target="_blank" className="btn btn-danger btn-lg text-white text-decoration-none">
            ...
            <section className="bg-yellow text-white text-center" >
                <div className="cust-grad p-5">
                    ...
                    <a href="https://wa.me/+237671752479" className="btn btn-danger btn-lg mt-2">Book Free Consultation</a>
                </div>
            </section>
        </>
    )
